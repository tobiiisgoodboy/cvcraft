  ...
  return (
    <div className="flex-shrink-0 border-b border-gray-100 bg-gray-50">
      ...
      <button
        ...
        className="w-full flex items-center gap-3 px-5 py-2 hover:bg-gray-100 transition-colors"
      >
        {/* Progress bar */}
        ...
        {/* Label */}
        <span className="text-xs text-gray-500 w-28 text-left">{scoreLabel(score)}</span>
      ...
      {expanded && missing.length > 0 && (
        <div className="px-5 pb-3 space-y-1">
          <p className="text-xs font-semibold text-gray-500 mb-1.5">Brakujące elementy:</p>
