...
const strings: Record<string, Record<PdfLang, string>> = {
  ...
  experienceShort:  { pl: 'Doświadczenie',           en: 'Experience' },
  ...
  awards:           { pl: 'Nagrody i wyróżnienia',   en: 'Awards & Honors' },
  skills:           { pl: 'Umiejętności',            en: 'Skills' },
  languages:        { pl: 'Języki obce',             en: 'Languages' },
  languagesShort:   { pl: 'Języki',                  en: 'Languages' },
